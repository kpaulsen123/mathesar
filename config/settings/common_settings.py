...
# Allow same-origin iframe embedding (needed for embedding Mathesar in Streamlit if same domain)
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'mathesar.exception_handlers.mathesar_exception_handler',
}
...
STATICFILES_DIRS = (
    [MATHESAR_UI_SOURCE_LOCATION, MATHESAR_STATIC_NON_CODE_FILES_LOCATION]
    if MATHESAR_MODE == 'DEVELOPMENT'
    else [MATHESAR_UI_BUILD_LOCATION, MATHESAR_STATIC_NON_CODE_FILES_LOCATION]
)
